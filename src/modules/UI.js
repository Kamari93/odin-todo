...
export default class UI {
    ...
    static loadTasks(projectName) {
        ...
        if (projectName !== 'Today' && projectName !== 'This Week' && projectName !== 'Brag List') {
    ...
    static initProjectButtons() {
        ...
        const bragProjectsButton = document.getElementById('button-brag-projects')
        ...
        bragProjectsButton.addEventListener('click', UI.openBragTasks)
    ...
    static openBragTasks() {
        UI.openProject('Brag List', this)
    }
